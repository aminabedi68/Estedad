...
<ul>
<li>font created.</li>
<li>merged with "corbel" regular for access better latin in more coordination.</li>
<li>some special features for Arabic-Persian fonts like arabic diacritics and numbers and some other public features like kerning and hinting(with ttfautohint) is available.</li>
</ul>
